                        ...
                        <div className="row">
                            <div className="col-sm-6  col-lg-4">
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="text" onChange={this.handleChange} value={this.state.lastName} className="form-control" id="LastName" name="lastName" />
                                </div>
                                <div className="form-group">
                                    <label htmlFor="CNIC"> CNIC Number</label>
                                    <input type="text" onChange={this.handleChange} value={this.state.cnicNumber} className="form-control" name="cnicNumber" id="CNIC" />
                                </div>
                                <div className="form-group">
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="text" name="userName" onChange={this.handleChange} value={this.state.userName} className="form-control" id="username" />
                                </div>
                                <div className="form-group">
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="password" name="confirmPassword" onChange={this.handleChange} value={this.state.confirmPassword} className="form-control" id="re-enter-password" />
                                </div>
                            ...
                            <div className="col-sm-6  col-lg-4">
                                <div className="form-group">
                                    ...
                                    <input type="text" name="company" onChange={this.handleChange} value={this.state.company} className="form-control" id="CompanyName" />
                                </div>
                                <div className="form-group">
                                    <label htmlFor="licenseNo">License Number</label>
                                    <input type="text" name="licenseNo" onChange={this.handleChange} value={this.state.licenseNo} className="form-control" id="licenseNo" />
                                </div>
                                <div className="form-group">
                                    <label htmlFor="companyemail">Company Email</label>
                                    <input type="email" name="companyEmail" onChange={this.handleChange} value={this.state.companyEmail} className="form-control" id="companyemail" />
                                </div>
                                <div className="form-group ">
                                    ...
                                    <div className="input-group ">
                                        ...
                                        <input type="text" onChange={this.handleChange} value={this.state.TelNo} className="form-control " id="telNo" name="TelNo" placeholder="Tel No" />
                                ...
                                <div className="form-group ">
                                    ...
                                    <div className="input-group ">
                                        ...
                                        <input type="text" onChange={this.handleChange} value={this.state.mobNumber} name="mobNumber" className="form-control " id="mobNo" />
                                    </div>
                                </div>
                                <div className="form-group ">
                                    <label htmlFor="address">Enter Address</label>
                                    <textarea rows="5" style={{ resize: "none" }} cols="10" value={this.state.address} className="form-control" id="address" onChange={this.handleChange} name="address" />
                                </div>
                            </div>
                            ...
                            <div className="col-sm-6  col-lg-4">
                                ...
                                <div className="form-group">
                                    ...
                                    <select className="form-control" onChange={this.handleChange} value={this.state.iataVerify} name="iataVerify" id="IATA">
                                ...
                                {this.state.iataVerify === "IATA" ? (
                                    <React.Fragment>
                                        <div className="form-group">
                                            ...
                                            <input type="text" name="IataNo" onChange={this.handleChange} value={this.state.iataNo} className="form-control" id="IATANO" />
                                        </div>
                                    </React.Fragment>
                                ) : ""}
