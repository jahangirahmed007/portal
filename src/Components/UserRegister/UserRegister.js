...
class UserRegister extends Component {
    state = {
        ...
        canactivateAgent: false,
        candeactivateAgent: false,
        candeleteAgent: false,
        canviewAgentsDealHistory: false,
        canapproveGroup: false,
        canrejectGroup: false,
        canapproveDemand: false,
        canrejectDemand: false,
    ...
    handleSubmit = (e) => {
        ...
        const userData = {
            ...
            cancreateAgent: this.state.cancreateAgent,
            canmodifyAgent: this.state.canmodifyAgent,
            canactivateAgent: this.state.canactivateAgent,
            candeactivateAgent: this.state.candeactivateAgent,
            candeleteAgent: this.state.candeleteAgent,
            canviewAgentsDealHistory: this.state.canviewAgentsDealHistory,
            canapproveGroup: this.state.canapproveGroup,
            canrejectGroup: this.state.canrejectGroup,
            canapproveDemand: this.state.canapproveDemand,
            canrejectDemand: this.state.canrejectDemand,
            canviewSubscriptions: this.state.canviewSubscriptions,
            canfindGroup: this.state.canfindGroup,
            cancreatePayment: this.state.cancreatePayment,
        }
    ...
    render() {
        ...
        return (
            <div className="bg-light pt-3 pb-3" >
                <h1 className="text-center"> USER REGISTERATION FORM</h1>
                        ...
                        <div className="row">
                            <div className="col-sm-6  col-lg-4">
                                <div className="form-group">
                                    ...
                                    <input type="text" onChange={this.handleChange} value={this.state.firstName} className="form-control " id="FirstName" name="firstName" />
                                </div>
                                <div className="form-group">
                                    <label htmlFor="LastName">Last Name </label>
                                    <input type="text" className="form-control" id="LastName" onChange={this.handleChange} value={this.state.lastName} name="lastName" />
                                </div>
                                <div className="form-group">
                                    <label htmlFor="CNIC"> CNIC Number</label>
                                    <input type="text" className="form-control" id="CNIC"
                                        name="cnicNumber"
                                        onChange={this.handleChange} value={this.state.cnicNumber} />
                                </div>
                                <div className="form-group ">
                                    ...
                                    <div className="input-group ">
                                        ...
                                        <input type="text" className="form-control "
                                            name="mobNumber"
                                            id="telNo" onChange={this.handleChange} value={this.state.mobNumber} />
                                    </div>
                                </div>
                                <div className="form-group ">
                                    <label htmlfor="address">Enter Address</label>
                                    <textarea rows="5" style={{ resize: "none" }} cols="10" className="form-control" id="address" name="address" onChange={this.handleChange} value={this.state.address} />
                                </div>
                            </div>
                            ...
                            <div className="col-sm-6  col-lg-4">
                                ...
                                <div className="form-group">
                                    ...
                                    <input name="confirmPassword" type="password" className="form-control" id="re-enter-password" onChange={this.handleChange} value={this.state.confirmPassword} />
                                </div>
                                <div className="form-group">
                                ...
                                <div className="ml-5">
                                    ...
                                    <div className="custom-control custom-checkbox mb-3">
                                        <input type="checkbox" className="custom-control-input"
                                            ...
                                            onClick={this.handleChecked} id="create"
                                            value={this.state.cancreateAgent}
                                            name="cancreateAgent" checked={this.state.checked} />
                                        <label className="custom-control-label" htmlFor="create">Create an Agent</label>
                                    </div>
                                    <div className="custom-control custom-checkbox mb-3">
                                        <input type="checkbox" onClick={this.handleChecked} id="create"
                                            value={this.state.canmodifyAgent}
                                            name="canmodifyAgent" className="custom-control-input" id="modify" />
                                        <label className="custom-control-label" htmlFor="modify">Mofify an agent  </label>
                                    </div>
                                    <div className="custom-control custom-checkbox mb-3">
                                        <input type="checkbox" onClick={this.handleChecked} id="create"
                                            value={this.state.canactivateAgent}
                                            name="canactivateAgent" className="custom-control-input" id="active" />
                                        <label className="custom-control-label" htmlFor="active">Activate an Agent </label>
                                    </div>
                                    <div className="custom-control custom-checkbox mb-3">
                                        <input type="checkbox" onClick={this.handleChecked} id="create"
                                            value={this.state.candeactivateAgent}
                                            name="candeactivateAgent" className="custom-control-input" id="deactivate" />
                                        <label className="custom-control-label" htmlFor="deactivate">Deactivate an Agent</label>
                                    </div>
                                    <div className="custom-control custom-checkbox mb-3">
                                        <input type="checkbox" onClick={this.handleChecked} id="create"
                                            value={this.state.candeleteAgent}
                                            name="candeleteAgent" className="custom-control-input" id="delete" />
                                        <label className="custom-control-label" htmlFor="delete">Delete an Agent</label>
                                    </div>
                                    <div className="custom-control custom-checkbox mb-3">
                                        <input type="checkbox" onClick={this.handleChecked} id="create"
                                            value={this.state.canviewAgentsDealHistory}
                                            name="canviewAgentsDealHistory" className="custom-control-input" id="details" />
                                        <label className="custom-control-label" htmlFor="details">View Agents Deals History </label>
                                    </div>
                                    <div className="custom-control custom-checkbox mb-3">
                                        <input type="checkbox" onClick={this.handleChecked} id="create"
                                            value={this.state.canapproveGroup}
                                            name="canapproveGroup" className="custom-control-input" id="approve" />
                                        <label className="custom-control-label" htmlFor="approve">Approve a Group</label>
                                    </div>
                                    <div className="custom-control custom-checkbox mb-3">
                                        <input type="checkbox" onClick={this.handleChecked} id="create"
                                            value={this.state.canrejectGroup}
                                            name="canrejectGroup" className="custom-control-input" id="reject" />
                                        <label className="custom-control-label" htmlFor="reject">Reject a Group</label>
                                    </div>
                                    <div className="custom-control custom-checkbox mb-3">
                                        <input type="checkbox" onClick={this.handleChecked} id="create"
                                            value={this.state.canapproveDemand}
                                            name="canapproveDemand" className="custom-control-input" id="appdemand" />
                                        <label className="custom-control-label" htmlFor="appdemand">Approve a Demand</label>
                                    </div>
                                    <div className="custom-control custom-checkbox mb-3">
                                        <input type="checkbox" onClick={this.handleChecked} id="create"
                                            value={this.state.canrejectDemand}
                                            name="canrejectDemand" className="custom-control-input" id="Regdemand" />
                                        <label className="custom-control-label" htmlFor="Regdemand">Reject a Demand</label>
                                    </div>
                                    <div className="custom-control custom-checkbox mb-3">
                                        <input type="checkbox" onClick={this.handleChecked} id="create"
                                            value={this.state.canviewSubscriptions}
                                            name="canviewSubscriptions" className="custom-control-input" id="subs" />
                                        <label className="custom-control-label" htmlFor="subs">View Subscriptions</label>
                                    </div>
                                    <div className="custom-control custom-checkbox mb-3">
                                        <input type="checkbox" onClick={this.handleChecked} id="create"
                                            value={this.state.canfindGroup}
                                            name="canfindGroup" className="custom-control-input" id="group" />
                                        <label className="custom-control-label" htmlFor="group">Find a Group</label>
                                    </div>
                                    <div className="custom-control custom-checkbox mb-3">
                                        <input type="checkbox" onClick={this.handleChecked} id="create"
                                            value={this.state.cancreatePayment}
                                            name="cancreatePayment" className="custom-control-input" id="payment" />
                                        <label className="custom-control-label" htmlFor="payment">Create Payment</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <button type="submit" onClick={this.handleSubmit} className="btn btn-primary px-4">Create</button>
                    </form>
