...
export default class MyNames extends Component {
  render() {
    return (
        ...
        <div className="container  w-75 text-center mt-5">
          ...
          <div className=" container d-flex justify-content-around border border-dark  pt-1 ">
            ...
            <div className="text-center d-flex flex-column ">
              <button className="btn btn-info"> Not Yet Approved</button>
            </div>
          </div>
          <div className="text-center d-flex justify-content-center pt-3">
            <button className="btn btn-primary ml-4 btn-lg">
              Edit for 1 Time
            </button>
            <button className="btn btn-secondary ml-4 btn-lg">
              Check Fares
            </button>
            <button className="btn btn-danger ml-4 btn-lg">Delete</button>
          </div>
        </div>
      </div>
    );
