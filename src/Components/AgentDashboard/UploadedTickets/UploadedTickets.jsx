...
export default class UploadedTickets extends Component {
  render() {
    return (
      <div className="container-fluid bg-light mt-2 pt-3 pt-5 pb-5 ">
        <div className="container ">
          ...
          <div className="text-center pt-2">
            <button className="btn btn-primary mr-4">Edit for 1 Time</button>
            <button className="btn btn-primary">Delete Group</button>
          </div>
        </div>
      </div>
    );
