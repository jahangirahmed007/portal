...
module.exports = function ValidateRegisterInput(data) {
    ...
    if (validator.isEmpty(data.iataVerify)) {
        errors.iataVerify = "IATA  field is  required"
    }
    if (validator.isEmpty(data.iataNo)) {
        errors.iataNo = "IATA Number field is  required"
    }
